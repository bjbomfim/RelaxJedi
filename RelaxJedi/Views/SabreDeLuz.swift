...
struct SabreDeLuz: View {
    ...
    var body: some View {
        VStack{
            ZStack{
                Rectangle()
                    .fill(Color(sabre.cor.rawValue))
                    .frame(width: 20, height: CGFloat(sabre.tamanho))
                    .overlay(Color(sabre.cor.rawValue).opacity(0.1))
                    .cornerRadius(CGFloat(90))
                    .shadow(color: Color(sabre.cor.rawValue), radius: 50)
                    .opacity(0.9)
                Rectangle()
                    .fill(.white)
                    .frame(width: 18, height: CGFloat(sabre.tamanho))
                    .cornerRadius(CGFloat(90))
                    .shadow(color: Color(sabre.cor.rawValue), radius: 20)
                    .opacity(0.5)
                Rectangle()
                    .fill(.white)
            ...
            ZStack{
                Ellipse()
                    .fill(Color(sabre.cor.rawValue).opacity(0.01))
